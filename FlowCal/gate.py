...
def contour2d(data,
    ...
    """
    Gate by taking in a contour generated by a previous run of density2d
    and applying it to other samples
    ...
    mask = path.contains_points(data_ch)
    ...
    if full_output:
        return Density2dGateOutput(
            gated_data=gated_data, mask=mask, contour=gate_contour)
    else:
        return gated_data
